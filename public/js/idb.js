...
request.onsuccess = function(event) {
  ...
  // This function will be executed if we attempt to submit a change to the budget and there's no internet connection
    ...
    if (getAll.result.length > 0) {
      fetch('/api/transaction', {
        ...
        .then(serverResponse => {
          ...
          const pizzaObjectStore = transaction.objectStore('budget');
